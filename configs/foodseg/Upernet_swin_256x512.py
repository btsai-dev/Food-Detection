...
model = dict(
    ...
    decode_head=dict(
        type='UPerHead',
        in_channels=[int(HEIGHT/8), int(HEIGHT/4), int(HEIGHT/2), int(HEIGHT)],
        in_index=[0, 1, 2, 3],
        pool_scales=(1, 2, 3, 6),
        channels=int(HEIGHT/2),
        dropout_ratio=0.1,
        num_classes=104,
        norm_cfg=norm_cfg,
        align_corners=False,
    ...
    auxiliary_head=dict(
        type='FCNHead',
        in_channels=int(HEIGHT/2),
        in_index=2,
        channels=int(HEIGHT/4),
        num_convs=1,
        concat_input=False,
        dropout_ratio=0.1,
        num_classes=104,
