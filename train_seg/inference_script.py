...
CONFIG = ROOT_DIR + "/checkpoints/seg_model/Upernet_swin_256x512.py"

WORK_DIR = ROOT_DIR + "/checkpoints/seg_model_infer"
SHOW_DIR = WORK_DIR + "/painted"
FORMAT_ONLY = False
CHECKPOINT = ROOT_DIR + "/checkpoints/seg_model/latest.pth"
OUT = None
EVAL = "mIoU"
